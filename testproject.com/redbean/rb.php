...
class TagManager
{
	 ...
	 *
	 * <code>
	 * R::hasTag( $project, 'horror,movie', TRUE );
	 * </code>
	 *
	 * The example above returns TRUE if the $project bean has been tagged
	 ...
	 *
	 * <code>
	 * R::untag( $project, 'smart,interesting' );
	 * </code>
	 *
	 * In the example above, the $project bean will no longer
	 ...
	 *
	 * <code>
	 * R::addTags( $project, ["halloween"] );
	 * </code>
	 *
	 * The example adds the tag 'halloween' to the $project
	 * bean.
	 *
	 * @param OODBBean $bean    bean to tag
